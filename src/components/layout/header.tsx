...
import { List } from 'lucide-react'; // Icon for collection
      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav>
          <ul className="flex items-center gap-4">
            <li>
              <Link href="/collection" className="flex items-center gap-1.5 text-sm font-medium transition-opacity hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-accent rounded-md px-2 py-1">
                <List size={18} />
                Collection
              </Link>
            </li>
