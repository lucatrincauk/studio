  ...
  return (
    <div className="space-y-8">
      <Card className="shadow-lg border border-border rounded-lg">
        <CardHeader>
          <CardTitle className="text-2xl">La Mia Collezione di Giochi</CardTitle>
          <CardDescription>Gestisci la tua collezione di giochi da tavolo sincronizzandola con BoardGameGeek e Firebase.</CardDescription>
        </CardHeader>
